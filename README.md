...
> Άνοιγμα αυτής της σελίδας στο [https://pmarkellou.github.io/hello-world/](https://pmarkellou.github.io/hello-world/)
...
* αναζήτηση για **https://github.com/pmarkellou/hello-world** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/pmarkellou/hello-world/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/pmarkellou/hello-world** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/pmarkellou/hello-world/raw/master/.github/makecode/blocks.png)
